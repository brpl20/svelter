...
│     └── Executa: vite                                              │
│                                                                     │
│  2. Vite inicia servidor em localhost:5173                         │
│     └── Pré-compila dependências (node_modules/.vite/)             │
│                                                                     │
│  3. Navegador acessa localhost:5173                                │
│     └── Vite serve index.html                                      │
│                                                                     │
│  4. Navegador parseia index.html                                   │
│     └── Encontra: <script type="module" src="/main.js">            │
│                                                                     │
│  5. Navegador requisita /main.js                                   │
│     └── Vite transforma e serve main.js                            │
│                                                                     │
│  6. Navegador parseia main.js                                      │
│     └── Encontra: import './style.css'                             │
│     └── Encontra: import { setupCounter } from './counter.js'      │
│                                                                     │
│  7. Navegador requisita style.css e counter.js                     │
│     └── Vite transforma CSS (injeta via JS)                        │
│     └── Vite serve counter.js                                      │
│                                                                     │
│  8. Aplicação renderiza! 🎉                                         │
│                                                                     │
└─────────────────────────────────────────────────────────────────────┘
```
