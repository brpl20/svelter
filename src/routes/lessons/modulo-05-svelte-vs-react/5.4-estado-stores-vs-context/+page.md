---
title: "Gerenciamento de Estado: Stores vs Context/Redux"
module: 5
order: 4
---

# 5.4 — Gerenciamento de Estado: Stores vs Context/Redux
...
<div class="not-prose my-6 rounded-xl border border-base-content/10 bg-base-200 p-6 font-mono text-sm">
  <div class="mb-3 text-center text-xs font-bold uppercase tracking-widest text-error">Prop Drilling</div>
  <div class="flex flex-col gap-0">
    <div class="ml-0">
      <span class="inline-block rounded bg-error px-3 py-1 font-bold text-white">App</span>
      <span class="ml-2 text-base-content/50">tem o estado <code class="text-warning">user</code></span>
    </div>
    <div class="ml-4 border-l-2 border-base-content/20 pl-4 pt-2">
      <span class="text-base-content/40">└──</span>
      <span class="inline-block rounded bg-base-300 px-3 py-1 text-base-content">Layout</span>
      <span class="ml-2 text-base-content/40">passa <code class="text-warning">user</code> ↓</span>
    </div>
    <div class="ml-12 border-l-2 border-base-content/20 pl-4 pt-2">
      <span class="text-base-content/40">└──</span>
      <span class="inline-block rounded bg-base-300 px-3 py-1 text-base-content">Sidebar</span>
      <span class="ml-2 text-base-content/40">passa <code class="text-warning">user</code> ↓</span>
    </div>
    <div class="ml-20 border-l-2 border-base-content/20 pl-4 pt-2">
      <span class="text-base-content/40">└──</span>
      <span class="inline-block rounded bg-base-300 px-3 py-1 text-base-content">UserMenu</span>
      <span class="ml-2 text-base-content/40">passa <code class="text-warning">user</code> ↓</span>
    </div>
    <div class="ml-28 border-l-2 border-success/30 pl-4 pt-2">
      <span class="text-base-content/40">└──</span>
      <span class="inline-block rounded bg-success px-3 py-1 font-bold text-white">Avatar</span>
      <span class="ml-2 text-success">finalmente usa <code class="text-warning">user</code>! ✓</span>
    </div>
  </div>
  <div class="mt-4 rounded bg-error/10 px-3 py-2 text-center text-error">
...
**Próxima aula:** [5.5 — Estilização: CSS com Escopo vs CSS-in-JS](../5.5-estilizacao-css-escopo)
